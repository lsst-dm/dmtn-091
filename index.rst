...
================
1. LARGE:
    * The HSC PDR that is currently processed bi-weekly satisfies needs for LARGE datasets.  This is presently (2019-09-10) available at NCSA at `/datasets/hsc/repo`.  The HSC dataset was defined in a JIRA ticket
